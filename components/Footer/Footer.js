...
const Footer = () => {
    return (
       <footer className={`${styles.footer} items-center flex flex-col py-[20px] px-[15px] bg-footer text-white container brandon`}>
            <Image src="/Icono_blanco.png" alt="hacer-comun" width={60} height={60} />
